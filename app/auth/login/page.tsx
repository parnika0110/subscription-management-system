...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Clear fields whenever page loads
    setEmail("");
    setPassword("");

    // Remove any old session values
      ...
      <div className="w-full max-w-md bg-white/85 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/50 p-10">
        ...
        <form autoComplete="off">
          <input
            ...
            className="w-full p-4 rounded-2xl border border-gray-300 bg-white text-[#111827] font-medium placeholder:text-gray-400 mb-4 outline-none focus:ring-2 focus:ring-[#0F766E]"
            value={email}
          ...
          <div className="relative mb-6">
            <input
              ...
              className="w-full p-4 rounded-2xl border border-gray-300 bg-white text-[#111827] font-medium placeholder:text-gray-400 outline-none focus:ring-2 focus:ring-[#0F766E]"
              value={password}
